...
public class ClientKillCountersCache {
    ...
    public static void set(UUID uuid, int demonLordKills, boolean hinataKilled, int hostileMobKills) {
        DATA.put(uuid, new int[]{demonLordKills, hinataKilled ? 1 : 0, hostileMobKills});
    }
